  ...
  const html = () => {
    ...
    <div class="perfu-container">
      ...
      <div class="perfu-container-conteudo">
        ...
        <img style="width:${props.attributes.useWidth}; height:${props.attributes.useHeight}  " class="comp-perfoleos-tamanho" id="${element.id}" img-src="${element.img}" alt="Dados Usuários">
          </a>
        `).join('')}
      </div>
      <div>
